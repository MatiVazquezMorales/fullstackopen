...
const App = () => {
  ...
  return (
    <div>
      ...
      <Valor_boton texto = 'all' valores = {good+neutral+bad} />
      <Valor_boton texto = 'average' valores = {(good+neutral)/(good+neutral+bad)} />
      <Valor_boton texto = 'positive' valores = {(good/good+neutral+bad) * 100} />
    </div>
  )
}
